...
public class Message {
	...
	public enum MessageType {
		...
		// The ie administrator statistic
		iegetstatistic,
		
		// The ie administrator statisticUserActivity to get the statistic user activity
		iegetstatisticUserActivity,
		
		// The ie administrator statisticNumberOfCrises to get the statistic number of sending crises
		iegetstatisticNumberOfCrises,
		
		// The ie administrator statisticTypes to get the statistic for the average time of the three types of a crises. 
		iegetstatisticTypes,
	 ...
	 * @param message
	 *            The string of the message attached
	 */
	...
	/**
	 * Creates a new message that only has a type The message part is initated
