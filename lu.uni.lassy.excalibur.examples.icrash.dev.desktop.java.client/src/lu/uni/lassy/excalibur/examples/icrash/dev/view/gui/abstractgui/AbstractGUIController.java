...
public abstract class AbstractGUIController implements Initializable {
	...
	public void setUpCoordTables(TableView<CtCoordinator> tblvw, boolean showPassword){
		...
		TableColumn<CtCoordinator, String> mailCol = new TableColumn<CtCoordinator, String>("E-mail");
		...
		mailCol.setCellValueFactory(new Callback<CellDataFeatures<CtCoordinator, String>, ObservableValue<String>>() {
			public ObservableValue<String> call(CellDataFeatures<CtCoordinator, String> coord) {
				return new ReadOnlyObjectWrapper<String>(coord.getValue().mail.value.getValue());
			}
		});
