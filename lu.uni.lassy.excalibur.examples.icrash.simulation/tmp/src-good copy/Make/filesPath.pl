...
% CHANGE ONLY THE FOLLOWING LINE (leave the quotes)
'/Volumes/Mac_data/Win_data/data/NG/dvlpt/eclipse/Workspace_Mars/lu.uni.lassy.excalibur.examples.icrash.simulation'
           ).

msrFilePath(
     latexProjectFolder,
% CHANGE ONLY THE FOLLOWING LINE (leave the quotes)
'/Volumes/Mac_data/Win_data/data/NG/dvlpt/eclipse/Workspace_Mars/lu.uni.lassy.excalibur.examples.icrash.simulation/latex'
           ).
