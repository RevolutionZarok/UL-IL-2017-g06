...
%-----------------------------------------------
:-msrTestAddStep([system,sim,2,7]).
%-----------------------------------------------
msrTest([[system,sim,2,7],
         [[target,oeAlert],
          [context,Context],
...
theSystem(TheSystem),
msrNav([TheSystem],
       [msmAtPre,rnactComCompany,msrAny,msrTrue],
       [TheActor]),
...
msrNav([AdtComment],
       [value],
       [[ptString,'3 cars involved in an accident.']]),
