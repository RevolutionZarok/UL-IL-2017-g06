...
:- newEvents(outputEvents, [outactCoordinator,oeSetCrisisHandler,[[etCrisisStatus],[ptBoolean]]]).
:- newEvents(outputEvents, [outactCoordinator,oeReportOnCrisis,[[dtAlertID,dtComment],[ptBoolean]]]).
