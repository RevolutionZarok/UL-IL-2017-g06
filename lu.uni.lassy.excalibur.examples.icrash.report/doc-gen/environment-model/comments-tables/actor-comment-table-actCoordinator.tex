...
\begin{actortable}
	...
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeCreateAlert}
			{\msrcode{oeCreateAlert():ptBoolean}}}
			{}
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeCreateCrisis}
			{\msrcode{oeCreateCrisis():ptBoolean}}}
			{}
	\addnumbereddoublerow{OUT}{\hypertarget{actCoordinator.outactCoordinator.oeUpdateCrisis}
			{\msrcode{oeUpdateCrisis():ptBoolean}}}
			{}
