...
The \msrcode{oeCaptchaValid} operation has the following properties:
	...
	\addnumberedsinglerow{PostF}{The user is notified by the system about the valid answer to the given captcha test by a message}
	...
	% ------------------------------------------
	\vspace{1cm}
	The listing~\ref{OM-actCaptchaValidator-oeCaptchaValid-MCL-LST} provides the \msrmessir (MCL-oriented) specification of the operation.
