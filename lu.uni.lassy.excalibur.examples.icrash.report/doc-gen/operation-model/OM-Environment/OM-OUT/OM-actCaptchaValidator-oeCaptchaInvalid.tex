...
The \msrcode{oeCaptchaInvalid} operation has the following properties:
	...
	\addnumberedsinglerow{PreP}{The actor for generating captcha tests must have first generated a captcha test and must have send it to the validating actor to store it locally}
		
	\addrowheading{Pre-Condition (functional)}
	\addnumberedsinglerow{PreF}{none}

	\addrowheading{Post-Condition (functional)}
	\addnumberedsinglerow{PostF}{The user is notified by the system about the invalid answer to the given captcha test by a message}
	...
	% ------------------------------------------
	\vspace{1cm}
	The listing~\ref{OM-actCaptchaValidator-oeCaptchaInvalid-MCL-LST} provides the \msrmessir (MCL-oriented) specification of the operation.
