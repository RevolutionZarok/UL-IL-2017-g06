...
\addalphanumberedsinglerow{}{the actor \msrcode{actCaptchaService} executes the \msrucname{oeSendCaptcha} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actAuthenticated} executes the \msrucname{oeSubmitCaptcha} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCaptchaService} executes the \msrucname{oeCaptchaInvalid} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCaptchaService} executes the \msrucname{oeCaptchaValid} use case}
