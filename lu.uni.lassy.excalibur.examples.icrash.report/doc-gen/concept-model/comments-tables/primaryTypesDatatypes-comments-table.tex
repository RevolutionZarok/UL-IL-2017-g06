...
\adddoubletwocolumnrow{attribute}{\msrcode{id: ptInteger}}{The internal id of this captcha test. This is used for the actCaptchaGenerator to identify the captcha test in case of a response.}
...
\addsingletwocolumnrow{extends}{dtString}
\adddoubletwocolumnrow{attribute}{\msrcode{height: ptInteger}}{Represents the height of the image in pixels}
\adddoubletwocolumnrow{attribute}{\msrcode{width: ptInteger}}{Represents the width of the image in pixels}
\adddoublerow{dtCaptchaResponse}{Contains the users response to a given captcha test}
\adddoubletwocolumnrow{attribute}{\msrcode{id: ptInteger}}{The internal id which qualifies the related captcha test}
...
\adddoubletwocolumnrow{attribute}{\msrcode{time: dtTime}}{The related timestamp}
\adddoublerow{dtTimestamp}{Crash timestamp composed of hour, minute and second}
\adddoubletwocolumnrow{attribute}{\msrcode{time: dtTime}}{The internal representation of the time stamp}
\end{datadictionary}
